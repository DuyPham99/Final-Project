                    ...
                    <Grid container spacing={3}>
                        <Grid item sm={5} sx={12}>
                            <div className="details__img">
                                <img src={data.productOptions[0].images != undefined ? data.productOptions[0].images : "" } alt="product" />
                            </div>
                        </Grid>
                        <Grid item sm={7} sx={12}>
                            <div className="details__info">
                                <h4 className="details__info-title">{data.name}</h4>
                                ...
                                <p className="details__info-des">Mô tả sản phẩm: <span>{data.description}</span></p>
                                <p className="details__info-price">
                                    <span>{currencyFormatVN(data.productOptions[0].price)}</span>
                                </p>
